...
namespace Ejercicio_5_9_2_6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            coord_x_p1 = Convert.ToDouble(Console.ReadLine());
            Console.Write("Introduce y1: ");
            coord_y_p1 = Convert.ToDouble(Console.ReadLine());
            Console.Write("Introduce x2: ");
            coord_x_p2 = Convert.ToDouble(Console.ReadLine());
            Console.Write("Introduce y2: ");
            coord_y_p2 = Convert.ToDouble(Console.ReadLine());
