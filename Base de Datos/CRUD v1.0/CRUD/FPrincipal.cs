...
namespace CRUD
{
    public partial class FPrincipal : Form
    {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if(saveFileDialog.ShowDialog()== DialogResult.OK)
                {
                    ...
                    MessageBox.Show("Archivo \"" + Path.GetFileName(saveFileDialog.FileName) + "\" se ha generado correctamente.",
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            if (cbCampos.Text == "")
            {
                MessageBox.Show("Debe introducir un valor a filtrar",
            ...
            if (txtBuscar.Text != "")
            {
                switch (cbCampos.Text)
                {
                    ...
                    case "Producto":
                        ...
                        switch (cb_comparacion.SelectedIndex)
                        {
                            case 0:
                                Scomparacion = " like '" + txtBuscar.Text + "%'";
                                break;
                            case 1:
                                Scomparacion = " like '%" + txtBuscar.Text + "%'";
                                break;
                        ...
                        sFiltro = cbCampos.Text + Scomparacion;
                        break;
                    default:
                        ...
                        sFiltro = cbCampos.Text + Scomparacion + txtBuscar.Text.Replace(',', '.');
                        break;
                }
            }
            try
        ...
        {
            cb_comparacion.Items.Clear();

            switch (cbCampos.Text)
            {
                case "Codigo":
                case "Precio":
                    cb_comparacion.Items.Add("Menor");
                    cb_comparacion.Items.Add("Menor o igual");
                    cb_comparacion.Items.Add("Igual");
                    cb_comparacion.Items.Add("Mayor o igual");
                    cb_comparacion.Items.Add("Mayor");
                    break;
                default:
                    cb_comparacion.Items.Add("Empieza por");
                    cb_comparacion.Items.Add("Contiene");
                    cb_comparacion.Items.Add("Termina por");
                    break;
            }
        }
    }
